...
#화면 타이틀 설정
pygame.display.set_caption("이성현의 첫번째 게임") # 게임 이름
...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:\\Users\\User\\Desktop\\python_game\\pygame_basic\\character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\User\\Desktop\\python_game\\pygame_basic\\enemy.png")
...
while running:
    ...
    # 경과 시간(ms)을 1000으로 나누어서 초단위로 표시
